...
function elaborarResultado(
  ...
  if (contador100 > 0) resultado += `${contador100} nota(s) de R$ 100. `;
  if (contador50 > 0) resultado += `\n${contador50} nota(s) de R$ 50. `;
  if (contador10 > 0) resultado += `\n${contador10} nota(s) de R$ 10. `;
  if (contador5 > 0) resultado += `\n${contador5} nota(s) de R$ 5. `;
  if (contador1 > 0) resultado += `\n${contador1} nota(s) de R$ 1. `;
  return resultado;
}
